...
const FabricCarousel: React.FC<FabricCarouselProps> = ({ items, autoPlay, autoPlaySpeed, transitionDuration }) => (
  <Carousel
    swipeable={true}
    draggable={true}
    showDots={true}
  ...
  >
    {items.map((item) => (
      <div className="collection-item fabric-carousel-item" key={item.code}>
        <div className="collection-placeholder fabric-carousel-placeholder">
          <img
            src={item.img}
            alt={item.desc}
            className="fabric-carousel-img"
          />
          {/* Watermark logo */}
          <img
            src={'/assets/logowatermark.png'}
            alt="AS Handloom watermark"
            className="fabric-carousel-watermark"
          />
        </div>
        <div className="fabric-carousel-overlay">
